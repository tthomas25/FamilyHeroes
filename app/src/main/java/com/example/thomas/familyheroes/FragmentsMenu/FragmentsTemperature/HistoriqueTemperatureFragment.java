 ...
 */
public class HistoriqueTemperatureFragment extends Fragment {
    ...
    public HistoriqueTemperatureFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_historique_temperature, container, false);
            ...
            getActivity().runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        params.add(new BasicNameValuePair("type_alerte", "3"));
