...
import com.example.thomas.familyheroes.FragmentsMenu.FragmentsTension.GraphiqueTensionFragment;
import com.example.thomas.familyheroes.FragmentsMenu.FragmentsTension.HistoriqueTensionFragment;
 ...
 */
public class TabsFragmentTemperature extends Fragment implements TabHost.OnTabChangeListener {
    //
    // Constants
    //
    private final TabDefinition[] TAB_DEFINITIONS = new TabDefinition[] {
            new SimpleTabDefinition(R.id.tab1, R.layout.fragment_graph_temperature, R.string.nothing, new GraphiqueTemperatureFragment()),
            new SimpleTabDefinition(R.id.tab2, R.layout.fragment_historique_temperature, R.string.nothing, new HistoriqueTemperatureFragment()),
    };
    ...
    //
    /**
     * Creates a {@link android.widget.TabHost.TabSpec} based on the specified parameters.
     * @param inflater The {@link LayoutInflater} responsible for creating {@link View}s.
     * @param tabHost The {@link TabHost} used to create new {@link android.widget.TabHost.TabSpec}s.
     ...
     * @return A new {@link android.widget.TabHost.TabSpec} instance.
     */
