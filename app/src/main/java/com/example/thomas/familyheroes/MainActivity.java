...
import com.example.thomas.familyheroes.FragmentsMenu.FragmentsCalendar.CalendarView;
import com.example.thomas.familyheroes.FragmentsMenu.FragmentsHardware.HardwareFragment;
...
import com.example.thomas.familyheroes.FragmentsMenu.FragmentsTemperature.TemperatureFragment;
...
public class MainActivity extends FragmentActivity {
    ...
    /*private final BroadcastReceiver mHandleMessageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            String newMessages = intent.getExtras().getString(CommonUtilities.EXTRA_MESSAGE);
    ...
    public void displayView(int position) {
        ...
        switch (position) {
            ...
            case 3:
                ...
                args3.putString("id", id);
                args3.putString("prenom", prenom);
                fragment.setArguments(args3);
                break;
            case 4:
                fragment = new CalendarView();
                Bundle args4 = new Bundle();
                args4.putString("id", id);
                args4.putString("prenom", prenom);
                fragment.setArguments(args4);
                break;
            case 5:
                fragment = new HardwareFragment();
                Bundle args5 = new Bundle();
                args5.putString("id", id);
                args5.putString("prenom", prenom);
            ...
            case 6:
                ...
                preferences.edit().remove("mailKey").commit();
                preferences.edit().remove("idKey").commit();
                preferences.edit().remove("mdpKey").commit();
                preferences.edit().remove("prenomKey").commit();
